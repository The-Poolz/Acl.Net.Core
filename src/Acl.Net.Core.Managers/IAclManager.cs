    ...
    where TResource : Resource<TKey>
{
    ...
    /// <summary>
    /// Determines asynchronously if the specified user by name is permitted to access the specified resource by name.
    /// </summary>
    /// <param name="userName">The name of the user to check permission for.</param>
    /// <param name="resourceName">The name of the resource to check permission against.</param>
    /// <returns>
    /// A task that represents the asynchronous operation.
    /// The task result contains <see langword="true"/> if the user is permitted to access the resource;
    ...
    /// <summary>
    /// Determines asynchronously if the specified user by name is permitted to access the specified resource object.
    /// </summary>
    /// <param name="userName">The name of the user to check permission for.</param>
    /// <param name="resource">The resource object to check permission against.</param>
    /// <returns>
    ...
    /// <summary>
    /// Determines asynchronously the resources that the specified user by name is permitted to access from a collection of resource names.
    /// </summary>
    /// <param name="userName">The name of the user to check permission for.</param>
    /// <param name="resourceNames">The collection of resource names to check permissions against.</param>
    /// <returns>
